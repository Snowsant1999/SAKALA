                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm text-slate-500 flex items-center gap-3 mt-0.5">
                            ...
                            <span class="flex items-center gap-1 font-medium text-slate-700">
                                <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M22 10v6M2 10l10-5 10 5-10 5z" /><path stroke-linecap="round" stroke-linejoin="round" d="M6 12v5c0 1.657 2.686 3 6 3s6-1.343 6-3v-5" /></svg>
                                {{ $schedule['class'] }}
                            </span>
                        </div>
                    </div>
